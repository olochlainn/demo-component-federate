...
link:#UUID-44c38ee5-aeec-1966-1a50-114cc6bf3fbb[dashboards] that display
...
link:#UUID-e773bdc8-6973-09d5-6104-6b29f300d19d[Discover], or start with
a new search query.

[[UUID-5982c3be-5f0e-ec1e-4bb1-f4ac8bfd023b]]
...
link:#UUID-5982c3be-5f0e-ec1e-4bb1-f4ac8bfd023b_UUID-510221c1-7f6b-bd94-bc74-57882376f02f[Visualization
types].
...
image:image/15d88cecb4998c.png[image]
...
image:image/15d88cecb50b10.png[image]
...
[cols=",",]
|===
|link:#UUID-88523206-1b84-cd03-c133-7bbbecfe53fe[Area, Line, and Bar
Charts] |Compare different series in X/Y charts.

|link:#UUID-94a79740-22b3-fb5e-6b29-3e7a760ea928[Boxplot Chart] |Display
data in an x/y chart using upper and lower percentiles.

|link:#UUID-7dfb8781-5712-859f-7589-1c4ec05fcbd5[Bubble Diagram] |Show
data and parent/child relationships as bubbles.

|link:#UUID-e485b4ec-0964-71ab-98e6-87aa7b847e40[Gauge and Goal]
|Display a gauge.

|link:#UUID-9dfad9e8-a840-762f-74f3-7589c6e4653e[Heat Map] |Shade cells
within a matrix.

|link:#UUID-82a30c72-d16e-c242-6459-6e98f3f3e110[Multichart] |A
visualization in which you can switch between other visualizations at
will.

|link:#UUID-ca5c9adb-2415-d579-2720-7cfeff61e898[Parallel Lines Chart]
|Arranges several metrics on parallel columns.

|link:#UUID-1568d3ec-7a1c-6f18-f122-def14384108d[Pie Chart] |Display
each source’s contribution to a total.

|link:#UUID-42232469-e607-25b0-9143-85af0f6f6f7c[Radar Chart] |A
...
[cols=",",]
|===
|link:#UUID-cdc5ce52-b982-7acd-81ae-c38c8855647f[Analytic Table]
|Display the raw data of a composed aggregation.

|link:#UUID-dc2acbc5-1f69-e985-52b7-f685401fc3e5[Markdown] |Display
free-form information or instructions.

|link:#UUID-07c3eacb-b0a4-7e18-a02b-45696eb11277[Metric] |Display a
single number.

|link:#UUID-f39f4458-a422-c71e-aaf5-a839758dbfc7[Query Viewer] |Display
the results from multiple queries on external datasources using query
templates.

|link:#UUID-9c0be2e0-2099-d73c-791f-b4f2b843fa80[Tag Cloud] |Display
words as a cloud in which the size of the word correspond to its
importance.

|link:#UUID-8548faab-7bd2-ce0a-a3c7-bd09b91f377d[Topic Clustering]
...
*Filters*::
  ...
  another filter. Click *Label* (image:image/15d88cecb57c46.png[image])
...
image:image/15d88cecb5e22b.png[An array of color dots that users can
select]
...
[[UUID-ec3bbeec-1c5a-39c9-b6c3-e29c5180a02a]]
...
image:image/15d88cecb74d2a.png[image]
...
image:image/15d88cecb7d265.png[image]
...
image:image/15d88cecb84f48.png[image]

image:image/15d88cecb8e51a.png[image]
...
image:image/15d88cecb950e4.png[image]
...
image:image/15d88cecb9d795.png[image]
...
image:image/15d88cecba5524.png[image]
...
image:image/15d88cecbac776.png[image]

Then, select rows which you wanted to create filters from and click
Create Filter.

image:image/15d88cecbb941e.png[image]
...
image:image/15d88cecbc1d36.png[image]

This will display a dialog box with several options.

image:image/15d88cecbc8c45.png[image]
...
image:image/15d88cecbcfbc6.png[image]
...
image:image/15d88cecbd7590.png[image]
...
image:image/15d88cecbdf003.png[image]
...
image:image/15d88cecbe7829.png[image]
...
image:image/15d88cecbeffcc.png[image]
...
image:image/15d88cecc0d3e5.png[Big Nodes Handling]
...
image:image/15d88cecc15a9f.png[Scripts Management]
...
image:image/15d88cecc1e641.png[Toolbar]
...
+
image:image/15d88cecc25158.png[Remove all]
...
+
image:image/15d88cecc2c400.png[Highlighting on]
+
image:image/15d88cecc35dad.png[Highlighting off]
...
+
image:image/15d88cecc3cdf3.gif[Standard layout]
+
image:image/15d88cecc4f676.gif[Hierarchy layout]
...
link:#[?xml_title]).
+
image:image/15d88cecc62fa4.png[Map mode]
...
image:image/15d88cecc86fc9.png[Navigation bar]
...
image:image/15d88cecc8dcd6.png[Side bar]
...
image:image/15d88cecc9558f.png[Side bar lenses tab]
...
image:image/15d88cecc9cdcf.png[Lens parameters]
...
image:image/15d88cecca3b88.png[Conditional lens]
...
image:image/15d88ceccab8be.png[Side bar - associate records based on
ontology lens]
...
image:image/15d88ceccb4ef6.png[vestment model graph view]
...
image:image/15d88ceccbdd18.png[Investment node]

You could obtain the associate records based on ontology as a result:

image:image/15d88ceccc60a4.png[Associate records based on ontology
result]
...
image:image/15d88ceccd4017.png[Selection tab]
...
image:image/15d88ceccdd0aa.png[Grid menu]
...
image:image/15d88cecce3eaf.png[Column menu]
...
image:image/15d88cecd0ed04.png[image]
...
image:image/15d88cecd26f31.png[Grouping on nodes]
...
image:image/15d88cecd3fd4f.png[Multichart]
...
image:image/15d88cecd497ac.png[Multi configurations]

*Visualize settings*

image:image/15d88cecd513ce.png[Visualize settings]
...
image:image/15d88cecd58fb8.png[New configuration]
...
image:image/15d88cecd60281.png[Input controls]

[[UUID-cdc5ce52-b982-7acd-81ae-c38c8855647f]]
== Analytic table
...
[[UUID-dc2acbc5-1f69-e985-52b7-f685401fc3e5]]
== Markdown widget
...
[[UUID-07c3eacb-b0a4-7e18-a02b-45696eb11277]]
== Metric
...
[[UUID-e485b4ec-0964-71ab-98e6-87aa7b847e40]]
== Goal and gauge
...
[[UUID-1568d3ec-7a1c-6f18-f122-def14384108d]]
== Pie charts
...
[[UUID-8f09fa78-b322-2c20-8e48-937baa0e5018]]
== Coordinate Map
...
[[UUID-bab747cc-92b6-bf21-65a1-811c52133bcd]]
...
Point of Interest layers::
  ...
  * Geo_shape type POI layers are suitable for viewing, popups and
  ...
  filters* below).
image:image/15d88cecd868e4.png[image]::
...
image:image/15d88cecd8dd9c.png[image]::
  ...
  ** *If you have added a URL to a CORS-enabled WMS server* -
  ...
  +
  image:image/15d88cecd9d429.png[image]
  ** *If your URL is not a CORS-enabled WMS server* - The UI will remain
  ...
  +
  image:image/15d88cecda4097.png[image]
  +
  ____
  *Note*
...
image:image/15d88cecdb21a7.png[image]
...
image:image/15d88cecdca0da.png[image]
____
...
[[UUID-5094f7e0-86e2-ecb3-ec8b-c8d553188e36]]
== Region Map
...
image:image/15d88cecdd72d5.png[regionmap]
...
[[UUID-5bae6e28-a647-cc8f-b491-7ba1f0cca6f8]]
...
image:image/15d88cecddfe12.png[Time Series Visual Builder Interface.]
...
image:image/15d88cecde6712.png[Time Series Visualization]
...
image:image/15d88cecdedff6.png[Metric Visualization]
...
image:image/15d88cece01119.png[Top N Visualization]
...
image:image/15d88cece08ac5.png[Gauge Visualization]
...
image:image/15d88cece103eb.png[Markdown Visualization]
...
image:image/15d88cece17f1e.png[Label Example]
...
image:image/15d88cece1f208.png[Derivative Example]
...
image:image/15d88cece2691b.png[Default series options]
...
image:image/15d88cece2d646.png[Time series options]
...
image:image/15d88cece35100.png[Annotation tab]
...
image:image/15d88cece3c949.png[Markdown tab]

[[UUID-9c0be2e0-2099-d73c-791f-b4f2b843fa80]]
== Tag clouds
...
[[UUID-8548faab-7bd2-ce0a-a3c7-bd09b91f377d]]
== Topic Clustering
...
image:image/15d88cece42ff2.png[image]
...
image:image/15d88cece4d06c.png[image]
...
image:image/15d88cece56c5d.png[image]
...
image:image/15d88cece5fe4a.png[image]
...
image:image/15d88cece67f87.png[image]
...
image:image/15d88cece70fa7.png[image]
...
image:image/15d88cece78052.png[image]
...
image:image/15d88cece810a8.png[image]
...
image:image/15d88cece8a864.png[image]
____
...
[[UUID-9dfad9e8-a840-762f-74f3-7589c6e4653e]]
== Heatmap chart
...
[[UUID-88523206-1b84-cd03-c133-7bbbecfe53fe]]
...
[[UUID-913916fe-4254-9c36-0e8e-54dea253a75c]]
== Timeline
...
image:image/15d88cece91da3.png[Timeline]
...
image:image/15d88cece9a19b.png[Timeline configuration]
...
image:image/15d88cecea32f2.png[Timeline advanced configuration]

In the timeline, each group is rendered on separate level:

image:image/15d88cecea9e60.png[Timeline]

[[UUID-d139b0d7-cf24-a2b5-84db-5ce99fa112d1]]
== Scatter Plot
...
image:image/15d88ceceb1c93.png[image]
...
image:image/15d88cecec4eac.png[Significant term]
...
image:image/15d88cececd8d0.png[Any aggregator]
...
[[UUID-42232469-e607-25b0-9143-85af0f6f6f7c]]
== Radar chart
...
image:image/15d88cecedb912.png[Radar chart visualization]

image:image/15d88cecee38cb.png[Radar chart settings]
...
image:image/15d88cecef3525.png[Box plot options]
...
[[UUID-7dfb8781-5712-859f-7589-1c4ec05fcbd5]]
== Bubble diagram

The bubble diagram visualization displays series of data grouped into
packed circles.

image:image/15d88cecf05d61.png[First]
...
image:image/15d88cecf0da1f.png[Aggregation configuration]
...
image:image/15d88cecf144af.png[Bubble movement]

Moving the mouse pointer over a circle shows detailed information in a
tooltip.

image:image/15d88cecf1b8c6.png[Detailed information on hover]
...
image:image/15d88cecf324d1.png[Filter parent]

[[UUID-54334d14-beb5-3d8e-ffda-84be7d6f62be]]
==== Horizontal Bar Chart

This visualization displays a horizontal bar chart from the data in the
current set of Elasticsearch documents.

image:image/15d88cecf39552.png[Horizontal bar chart]

[[UUID-ca5c9adb-2415-d579-2720-7cfeff61e898]]
...
image:image/15d88cecf406ad.png[A parallel lines chart]
...
image:image/15d88cecf4a931.png[A range filter and a value filter]
...
image:image/15d88cecf52661.png[Moving columns]
...
[[UUID-f39f4458-a422-c71e-aaf5-a839758dbfc7]]
== Query Viewer
...
image:image/15d88cecf6ebdb.png[Configuration of a Siren Investigate
...
image:image/15d88cecf76c56.png[Advanced options]

[[UUID-0bb1b6c6-db62-e8be-b15c-4f5689966c43]]
...
image:image/15d88cecf8015d.png[image]
...
image:image/15d88cecf87d75.png[image]

Make sure that WMS and WFS are enabled by selecting both on the
navigation pane on the left:

image:image/15d88cecf901ea.png[image]
