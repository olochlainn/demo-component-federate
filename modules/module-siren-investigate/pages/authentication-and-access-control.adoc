...
see xref:xref:authentication-and-access-control.adoc[Authentication and access control].
...
http://floragunncom.github.io/search-guard-docs/sgadmin.html[Using sgadmin to configure Search Guard].
