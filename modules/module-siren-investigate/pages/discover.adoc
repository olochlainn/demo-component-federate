...
[arabic]
. Click *Time Picker* (image:image/15d88cec89d28c.png[image]) in the
...
. Click the caret (image:image/15d88cec8bf71a.png[image]) in the bottom
...
information, see link:#UUID-7712c1b9-4a9b-1f1d-4456-aac12e622e6d[Sorting
the Documents Table].

To search your data, enter your search criteria in the Query bar and
press Enter or click Search (image:image/15d88cec8cf499.png[image]) to
...
selected index pattern.3.5. Visualize
...
link:#UUID-7a77e0a7-f9af-ebe3-023a-e5f8c8583d96[Creating an Index
Pattern].
...
[arabic]
. Click Time Picker (image:image/15d88cec89d28c.png[image]) in the Siren
Investigate toolbar.
. Click Auto refresh.
...
(image:image/15d88cec8e6362.png[image]). This includes only those
...
image:15d88cec95789d.png[image] Edit Filter::
  link:#UUID-bbbac2e6-269e-ea10-ef90-d5f4e92b1d63[Edit the filter]
...
link:#UUID-ec4879fe-bcd8-d24b-d037-201fb8585b73[*Selected Fields*] list.
...
*Remove* (image:image/15d88cec98c2a7.png[image]).
...
(image:image/15d88cec900aef.png[image]) to the left of the document’s
...
link:#UUID-44c38ee5-aeec-1966-1a50-114cc6bf3fbb[Dashboard].
...
ready to link:#UUID-b1dcfd44-c591-5197-e786-3608f9ad7213[generate a
dashboard].