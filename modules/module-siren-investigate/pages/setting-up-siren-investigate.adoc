...
If the Elasticsearch/Federate backend is more recent than the
...
Management to see this section).
...
[[UUID-a014aae1-5714-26fb-7132-e6ea60748276]]
...
link:#[?xml_title] or link:#[?xml_title]

|`+docker+` a|
Siren Investigate Docker images are available at
https://hub.docker.com/u/sirensolutions/.

https://www.elastic.co/guide/en/kibana/5.6/docker.html[Running Kibana on
Docker]
...
If your Elasticsearch installation is protected by
...
[[UUID-c8082842-27f2-99d0-8075-084dc59d0c35]]
...
[[UUID-3335905b-5590-bf00-508a-03a558fe4358]]
===== Pulling the Image
...
[[UUID-80b084a9-4ec2-14c1-d950-6748a6658111]]
...
In general, any setting listed in link:#[?xml_title] or
...
[[UUID-732a115b-09ba-6b12-2b12-f064586e682d]]
====== Docker defaults
...
[[UUID-5d9af5fb-1612-a639-71c2-6b3bcad94d08]]
...
[[UUID-eeeb8e5a-2925-3e4f-8506-d0062797571d]]
...
sha1sum siren-investigate-10.0.0-linux-x86_64.zip 
unzip siren-investigate-10.0.0-linux-x86_64.zip -d .
cd siren-investigate-10.0.0-linux-x86_64/ 
----
...
[[UUID-63326b06-b6e8-ca10-d001-ff2e6c2d763f]]
...
pressing [.keycombo]#Ctrl+C#.

[[UUID-5a573e31-4b51-c2a1-1c49-806417e17f10]]
...
of this configuration file is explained in link:#[?xml_title].

[[UUID-e4bd5125-be0f-be00-3dc9-71a7cc065b8f]]
...
[[UUID-214e3ba0-b367-de9a-52fe-713af2ade367]]
...
[[UUID-4e64cecb-c94a-0a69-3fdb-39d1a1324426]]
====== Running Siren Investigate from the command prompt
...
By default, Siren Investigate runs in the foreground, prints its logs to
`+STDOUT+`, and can be stopped by pressing [.keycombo]#Ctrl+C#.

[[UUID-3708dc53-135b-3a28-99fe-3b26dee4ed68]]
====== Siren Investigate configuration
...
[[UUID-5ebcef3b-7895-cf8a-2fe4-575aa035bc5a]]
...
[[UUID-d3a341cd-4152-1d47-a3d0-c95e7a6afb98]]
...
External datasource configuration is documented in the link:#[3.11. JDBC
datasources] and link:#[?xml_title] sections, while access control
configuration is documented in the link:#[?xml_title] section.3.11. JDBC
datasources
...
can still link:#UUID-aa266207-6dfd-596a-d978-fb2a9988476d[override this
...
link:#UUID-5094f7e0-86e2-ecb3-ec8b-c8d553188e36[Region Map]
...
regionmap: layers: name: "Departments of France" url:
"http://my.cors.enabled.server.org/france_departements.geojson"
attribution: "INRAP" fields: name: "department" description: "Full
department name" name: "INSEE" description: "INSEE numeric identifier"
...
[[UUID-55ac173b-2871-9697-a6c3-acd805c2b891]]
...
[[UUID-75679216-bac8-98d7-fa82-9c835bcc7d3b]]
...
image:image/15d88cec7b682e.png[Siren Investigate status page.]

[[UUID-651d9cd4-5185-09a0-2bf2-5a35c6e75f77]]
...
image:image/15d88cec7bfa48.png[Siren Investigate status page diagnostics
help.]
...
[[UUID-0182e64b-f238-9c70-7edd-9d70cc84c5d9]]
...
image:image/15d88cec7c9538.png[image]
...
image:image/15d88cec7d2c63.png[image]
...
[[UUID-536f87e6-1068-56fe-b68a-f52a10bbcb20]]
==== Using Siren Investigate with tribe nodes

____
*Note*

While tribe nodes have been deprecated in Elasticsearch in favor of
...
[[UUID-ef3a5e79-ec24-eb65-5858-d8e12f18715d]]
...
[[UUID-582f3fa4-41af-affb-3f9e-67a2ee70b071]]
...
When upgrading both Investigate and Elasticsearch, you should upgrade
...
Before you upgrade Siren Investigate, you must take account of the
...
security) if requiredIntroduction
...
link:/document/preview/74614#UUID-614c3407-2425-bbec-d555-cf99fc9605ff[Breaking
Changes] and the link:#UUID-c90c7882-8ae2-2392-260c-ef61485f6027[Search
Guard Integration and Siren Investigate access control]8. Breaking
changes
...
Elasticsearch requires a matching version of Search Guard. For example,
...
[[UUID-43028529-accb-ba05-df2a-f1c0c0f82b5b]]
