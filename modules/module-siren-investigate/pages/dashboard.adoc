...
xref:visualizations.adoc#multichart[Multichart
...
xref:discover.adoc#searching-your-data[saved search], which by
...
xref:visualizations.adoc#analytic-table[ranking] returns the
...
document link:/document/preview/60150#UUID-6c99b59a-ddaa-708c-9536-7ff56550921f[filter].
