...
xref:module-siren-investigate:dashboard.adoc[Dashboards]
...
xref:module-siren-investigate:discover.adoc#_searching_your_data[saved
...
Source xref:module-siren-investigate:visualizations.adoc#_pie_chart[pie
chart] visualization.
...
The
xref:module-siren-investigate:relational-browsing.adoc#_relational_navigator[Relational
...
see xref:module-siren-investigate:relational-browsing.adoc#_relational_navigator[Relational
Navigator].
...
(image:15d764ed143f43.png[image]) in the heading of the *Query on
...
Changes* (image:15d764ed153f9c.png[image]).
...
Changes* (image:15d764ed153f9c.png[image]) to add an external ring
