...
The
ifdef::output-html[xref:module-siren-investigate:relational-browsing.adoc#_relational_navigator[Relational Navigator]] visualization enables you to create cross-dashboard filters.
